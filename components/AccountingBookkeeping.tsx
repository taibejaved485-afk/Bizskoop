  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl text-center sm:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black mb-6 sm:mb-8 leading-tight tracking-tighter uppercase animate-fadeIn">
              ...
              <span className="text-gold">Accounting &</span> <br className="hidden sm:block"/>
              Bookkeeping
            </h1>
            ...
            <div className="flex justify-center sm:justify-start gap-6 animate-fadeIn" style={{ animationDelay: '0.4s' }}>
              <a href="#accounting-contact" className="px-8 sm:px-10 py-4 sm:py-5 bg-gold text-navy-dark font-black rounded-lg hover-bg-gold transition shadow-xl uppercase tracking-widest text-xs sm:text-sm w-full sm:w-auto text-center">
                Get a Quote
              </a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-1/2 text-center lg:text-left">
              <h2 className="text-gold font-black text-[10px] sm:text-xs uppercase tracking-[0.3em] sm:tracking-[0.4em] mb-4">Financial Integrity</h2>
              <h3 className="text-3xl sm:text-4xl font-black text-royal-blue mb-6 sm:mb-8 uppercase tracking-tight">Why Precision <br className="hidden sm:block"/>Matters Most.</h3>
            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative">
                <div className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 w-20 sm:w-24 h-20 sm:h-24 bg-gold/10 rounded-2xl -z-10"></div>
                <img 
      ...
      <section className="py-16 sm:py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl font-black text-royal-blue uppercase tracking-tighter">Core Financial Solutions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-slate-100 hover:border-gold transition-all group">
                ...
                <p className="text-slate-600 text-xs sm:text-sm font-medium leading-relaxed">{s.desc}</p>
              </div>
            ))}
            <div className="bg-navy-dark p-8 sm:p-10 rounded-2xl shadow-xl flex flex-col justify-center items-center text-center border-b-4 sm:border-b-8 border-gold">
              <h4 className="text-lg sm:text-xl font-black text-gold mb-4 uppercase tracking-tighter">Custom Packages</h4>
              <p className="text-blue-100 text-xs sm:text-sm font-medium mb-6">Scalable solutions tailored to your specific business volume.</p>
              <a href="#accounting-contact" className="px-6 py-3 bg-gold text-navy-dark font-black rounded-lg uppercase text-[10px] sm:text-xs tracking-widest hover:bg-white transition-colors w-full sm:w-auto">Talk to Us</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            <span className="text-gold font-black text-[10px] sm:text-xs uppercase tracking-[0.3em] sm:tracking-[0.4em] block mb-4">Precision Pipeline</span>
            <h2 className="text-3xl sm:text-4xl font-black text-royal-blue uppercase tracking-widest">Our Accounting Workflow</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="group relative p-[2px] rounded-[34px] sm:rounded-[42px] overflow-hidden transition-all duration-500 hover:-translate-y-2">
                {/* Rotating Glow Layer */}
                ...
                <div 
                  className="liquid-box relative h-full bg-[#081b2a] p-8 sm:p-10 rounded-[32px] sm:rounded-[40px] border border-white/5 shadow-2xl transition-all duration-500 overflow-hidden cursor-default z-10"
                ...
                >
                  ...
                  <div className="w-12 h-1.5 bg-gold mb-6 sm:mb-10 rounded-full group-hover:w-20 transition-all duration-500"></div>
                  
                  {/* Content */}
                  <div className="relative z-10">
                    <h4 className="text-lg sm:text-xl font-black mb-4 sm:mb-6 uppercase tracking-tight text-white group-hover:text-gold transition-colors">
                      {p.title}
                    </h4>
                  ...
                  <div className="absolute bottom-6 right-8 text-[10px] font-black text-gold/40 uppercase tracking-widest">
                    Phase {p.step}
                  </div>
                </div>
              </div>
      ...
      {/* 5. Lead Gen Footer */}
      <section className="py-16 sm:py-32 bg-slate-50 border-t border-slate-100" id="accounting-contact">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white p-8 sm:p-12 lg:p-16 rounded-[30px] sm:rounded-[40px] shadow-2xl border-2 border-gold/20">
            <h2 className="text-2xl sm:text-3xl font-black text-royal-blue mb-4 text-center uppercase tracking-tight">Stop Worrying About Your Accounts.</h2>
            <p className="text-slate-600 text-center mb-10 sm:mb-12 font-medium text-sm sm:text-base">Let us handle the numbers while you build your empire. Request your custom quote below.</p>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <textarea placeholder="Tell us about your accounting needs (e.g. monthly transactions volume, existing backlog)..." className="w-full h-[156px] px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:border-gold outline-none font-medium resize-none text-sm"></textarea>
