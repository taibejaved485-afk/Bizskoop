...
const ContactPage: React.FC = () => {
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative text-white py-20 sm:py-32 lg:py-48 overflow-hidden group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl text-center sm:text-left">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-gold/20 backdrop-blur-md border border-gold/30 text-gold text-[8px] sm:text-[10px] font-black uppercase tracking-[0.3em] sm:tracking-[0.4em] mb-6 sm:mb-8 animate-fadeIn">
              <span className="w-2 h-2 rounded-full bg-gold animate-pulse"></span>
              Global Business Gateway
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-8xl font-black mb-6 sm:mb-8 leading-[1] tracking-tighter uppercase animate-fadeIn">
              Strategic <br className="hidden sm:block"/>
              <span className="text-gold">Partnership</span> <br className="hidden sm:block"/>
              Starts Here
            </h1>
            <p className="text-base sm:text-xl text-blue-100 mb-8 sm:mb-12 leading-relaxed font-black animate-fadeIn max-w-2xl drop-shadow-md mx-auto sm:mx-0" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="text-center sm:text-left">
              <h2 className="text-gold font-black text-[10px] sm:text-xs uppercase tracking-[0.3em] sm:tracking-[0.4em] mb-4">Direct Channels</h2>
              <h3 className="text-3xl sm:text-4xl font-black text-royal-blue mb-8 sm:mb-10 uppercase tracking-tight">Our Regional <br className="hidden sm:block"/>Headquarters.</h3>
              
              <div className="space-y-8 sm:space-y-12">
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 items-center sm:items-start group">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-navy-dark text-gold flex items-center justify-center shrink-0 shadow-xl group-hover:scale-110 transition-transform">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  </div>
                  <div>
                    <h4 className="text-base sm:text-lg font-black text-royal-blue uppercase tracking-tight mb-2">Corporate Office</h4>
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 items-center sm:items-start group">
                  ...
                  <div>
                    <h4 className="text-base sm:text-lg font-black text-royal-blue uppercase tracking-tight mb-2">Liaison Desk</h4>
                    <p className="text-slate-600 font-medium leading-relaxed text-sm sm:text-base">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 items-center sm:items-start group">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-navy-dark text-gold flex items-center justify-center shrink-0 shadow-xl group-hover:scale-110 transition-transform">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  </div>
                  <div>
                    <h4 className="text-base sm:text-lg font-black text-royal-blue uppercase tracking-tight mb-2">Email Channels</h4>
                    <p className="text-slate-600 font-medium leading-relaxed text-sm sm:text-base">
              ...
              <div className="mt-12 sm:mt-16 p-6 sm:p-8 bg-slate-50 rounded-[24px] sm:rounded-[30px] border border-slate-100 relative overflow-hidden text-left">
                <div className="absolute top-0 right-0 w-20 sm:w-24 h-20 sm:h-24 bg-gold opacity-5 rounded-bl-full"></div>
                <h4 className="text-xs sm:text-sm font-black text-royal-blue uppercase tracking-widest mb-4">International Founders</h4>
                <p className="text-slate-500 text-[10px] sm:text-xs font-bold leading-relaxed">
            ...
            {/* Right: Contact Form */}
            <div className="bg-white p-8 sm:p-10 lg:p-14 rounded-[30px] sm:rounded-[40px] shadow-2xl border-2 border-gold/20 relative">
      ...
      <section className="h-[400px] sm:h-[500px] w-full bg-slate-100 relative grayscale hover:grayscale-0 transition-all duration-700 overflow-hidden border-t-4 sm:border-t-8 border-gold">
        <iframe 
        ...
        <div className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8 z-10">
          <div className="bg-navy-dark text-white p-4 sm:p-6 rounded-2xl shadow-2xl border-b-4 border-gold">
            <h4 className="text-gold font-black text-[10px] sm:text-xs uppercase tracking-widest mb-2">Visit Our Office</h4>
            <p className="text-[10px] sm:text-xs font-medium leading-relaxed">Menara Binjai, Level 28<br/>Kuala Lumpur City Centre</p>
          </div>
        </div>
      </section>
    </div>
