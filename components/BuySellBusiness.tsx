...
const BuySellBusiness: React.FC = () => {
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-5xl lg:text-7xl font-black mb-8 leading-tight tracking-tighter uppercase animate-fadeIn">
              Confidential <br/>
              <span className="text-gold">M&A Advisory</span> <br/>
              & Brokerage
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 animate-fadeIn" style={{ animationDelay: '0.4s' }}>
              <a href="#buy-sell-contact" className="px-10 py-5 bg-gold text-navy-dark font-black rounded-lg hover:bg-white transition shadow-xl uppercase tracking-widest text-sm text-center">
                Browse Listings
              </a>
              <a href="#buy-sell-contact" className="px-10 py-5 bg-white/10 text-white border-2 border-white/20 font-black rounded-lg hover:bg-white/20 transition uppercase tracking-widest text-sm text-center">
                List Your Business
              </a>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="lg:w-1/2">
              <h2 className="text-gold font-black text-xs uppercase tracking-[0.4em] mb-4">Strategic Transaction</h2>
              <h3 className="text-4xl font-black text-royal-blue mb-8 uppercase tracking-tight">Protecting Your <br/>Legacy & Future.</h3>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-black text-royal-blue uppercase tracking-tighter">M&A Transaction Units</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-navy-dark p-10 rounded-2xl shadow-xl flex flex-col justify-center items-center text-center border-b-8 border-gold">
              <h4 className="text-xl font-black text-gold mb-4 uppercase tracking-tighter">Elite Portfolio</h4>
              <p className="text-blue-100 text-sm font-medium mb-6">Access our private list of 'Off-Market' opportunities in the F&B, Tech, and Manufacturing sectors.</p>
              <a href="#buy-sell-contact" className="px-6 py-3 bg-gold text-navy-dark font-black rounded-lg uppercase text-xs tracking-widest hover:bg-white transition-colors">Request Access</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-royal-blue mb-16 text-center uppercase tracking-widest">The M&A Roadmap</h2>
      ...
      {/* 5. Lead Gen Footer */}
      <section className="py-32 bg-slate-50 border-t border-slate-100" id="buy-sell-contact">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white p-12 lg:p-16 rounded-[40px] shadow-2xl border-2 border-gold/20">
            <h2 className="text-3xl font-black text-royal-blue mb-4 text-center uppercase tracking-tight">Your Next Big Move Starts Here.</h2>
            <p className="text-slate-600 text-center mb-12 font-medium">Confidentiality is our currency. Tell us about your investment or exit goals.</p>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <input type="text" placeholder="Target Industry (e.g. F&B, Logistics)" className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:border-gold outline-none font-medium" />
              </div>
              <div className="space-y-6">
                <input type="text" placeholder="Budget / Asking Price (MYR)" className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:border-gold outline-none font-medium" />
                <textarea placeholder="Tell us about the business profile or your acquisition mandate..." className="w-full h-[88px] px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:border-gold outline-none font-medium resize-none"></textarea>
