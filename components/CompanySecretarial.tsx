    ...
    <div className="bg-white min-h-screen selection:bg-gold selection:text-navy-dark" ref={containerRef}>
      ...
      <section className="relative bg-[#051622] text-white py-12 sm:py-16 lg:py-20 overflow-hidden flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center lg:text-left">
          ...
          >
            ...
            >
              Elite <span className="text-gold">Company Secretarial</span> & Compliance
            </motion.h1>
            <motion.p 
              variants={{
                hidden: { opacity: 0, y: 20 },
      ...
      <section id="expertise" className="py-12 sm:py-16 bg-slate-50 border-y border-slate-100 relative overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-20 right-0 w-72 h-72 bg-gold/5 rounded-full blur-[100px] -z-10"
        />
        <motion.div 
          style={{ y: useTransform(scrollYProgress, [0, 1], [0, 100]) }}
          className="absolute bottom-20 left-0 w-72 h-72 bg-royal-blue/5 rounded-full blur-[100px] -z-10"
        />
            ...
            <div className="lg:w-2/5 p-12 lg:p-20 bg-gradient-to-br from-navy-dark to-[#081b2a] border-r border-white/5 relative flex flex-col justify-center">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl lg:text-5xl font-black text-white mb-6 uppercase tracking-tight leading-tight">
                  The <span className="text-gold">Bizskoop</span> <br/>Guarantee.
                </h2>
