    ...
    <div className="min-h-screen bg-white">
      ...
      {currentPage === 'home' ? (
        <>
          ...
          <section id="about" className="bg-white py-24 relative overflow-hidden scroll-mt-20 group/about-section">
              ...
              <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                ...
                <div className="space-y-8 lg:pl-10">
                  <div>
                    ...
                    <div className="text-slate-600 text-lg leading-relaxed font-medium mb-10 min-h-[6rem]">
                      <TypingText 
